...
const titles=[
{name:'', img:wallaceGromit, newRelease:true, type:'Monosemia/Polisemia - Wallace & Gromit', genre:'Children', tags:['Here, we can easily understand the concept of common fate by distinguishing on this cover three faces : each one of a different color to represent each member of the trio. However, they are also unified, in a sense, as they share the same outline.']},
