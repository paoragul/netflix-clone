...
{name:'Los Looney Tunes', img:looney_tunes, newRelease:false, type:'Dibujo realista - Los Looney Tunes', genre:'Grado de iconicidad', tags:['Esto es un dibujo realista de los Looney Tunes.']},
{name:'Abstracto I', img:abstrait1, newRelease:true, type:'Representacion - Abstracto I', genre:'Grado de iconicidad', tags:['Esto es una illustracion abstracta.']},
...
{name:'Abstracto II', img:abstrait2, newRelease:false, type:'Abstracta o no representativa', genre:'Abstraccion/Figuracion', tags:['Esto es una illustracion abstracta.']},
]
