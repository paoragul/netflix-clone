...
import simposon from '../../img/titles/grano_de_iconicidad/simpson_2_crop.png';
...
const titles=[
{name:'', img:wallaceGromit, newRelease:true, type:'Monosemia/Polisemia - Wallace y Gromit', genre:'Children', tags:['Wallace y Gromit es una serie de películas británicas realizadas mediante la técnica de la animación en volumen. Se trata de figuras elaboradas con plastilina, por lo que son representaciones en 3D.']},
{name:'Street Food', img:simposon, newRelease:true, type:'Realidad - Los Simpson', genre:'Grado de iconicidad', tags:['Visionary','Food & Wine','Docuseries']},
