...
//Grado de iconicidad
{name:'Los Simpson', img:simpson, newRelease:true, type:'Realidad - Los Simpson', genre:'Grado de iconicidad', tags:['Visionary','Food & Wine','Docuseries']},
...
{name:'Avengers', img:avengers, newRelease:true, type:'Movie', genre:'Grado de iconicidad', tags:['Exciting','Super Hero','Sci Fi']},
{name:'Final Destination', img:final, newRelease:false, type:'Movie', genre:'Grado de iconicidad', tags:['Exciting','Super Hero','Sci Fi']},
{name:'Planet Earth 2', img:earth, newRelease:false, type:'TV', genre:'Grado de iconicidad', tags:['Limited Series','Science & Nature','All Things Wild']},
{name:'Gremlins', img:gremlins, newRelease:false, type:'Movie', genre:'vGrado de iconicidad', tags:['Visionary','Food & Wine','Docuseries']},
{name:'Incredibles 2', img:incredibles, newRelease:true, type:'Movie', genre:'Grado de iconicidad', tags:['Horror','Post Apocolypse','Zombies']},
